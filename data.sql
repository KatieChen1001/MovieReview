-- create a list that stores all movie data 
...
SET @IMAGE_BASE_URL = "https://movie-1257643707.cos.ap-guangzhou.myqcloud.com/"; 
...
-- user (who published the comment)| movie id | comment content
...
INSERT INTO `movie_comment` (`id`, `user`, `username`, `useravatar`, `content`, `movie_id`, `type`) VALUES
(1, 'oCU7b4qcucEk2O2uv0t0Xo10w_3I', 'jie', 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJbOnwTr6w3L1tEKRhHQ5XJBBCQSHQQSay5jg4mibyeiakSpvqSjexVBrzXeNBk9icRtDQBoiaPaqUUFg/132', '非常好看的一部电影，童年喜欢看的', 10, 'text'),
(2, 'oCU7b4sTKBAIYdQWn7H0obmmXPbU', '苏樱?', 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJmwxw0wpXQiagqUrr3BOlB4Aj276SszMHZiaicPXoWKc3XhVj5lFcY4dQfxMTrrQ2NiaEThRBDib7UyJw/132', '对梅姨强大的气场印象深刻。', 2, 'text'),
(3, 'oCU7b4s5YbpJ6RMI5LtvSMWgWMGQ', '烟花易冷', 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTK1ZRDv3Rm21ibIxJhSmPngs5UELuh5oyuyfCG3pTx0hrscGZywaYydjp3QAeh4fq8JbFn3oFLg4MQ/132', '电影非常好看', 4, 'text')
(4, 'oCU7b4s5YbpJ6RMI5LtvSMWgWMGQ', '烟花易冷', 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTK1ZRDv3Rm21ibIxJhSmPngs5UELuh5oyuyfCG3pTx0hrscGZywaYydjp3QAeh4fq8JbFn3oFLg4MQ/132', CONCAT(@AUDIO_BASE_URL, '1.mp3'), 4, 'audio')